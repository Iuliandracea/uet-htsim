...
public:
    ...
    DragonFlyPlusTopology(uint32_t radix, linkspeed_bps linkspeed, mem_b queuesize, QueueLoggerFactory* logger_factory,EventList* ev,queue_type q, simtime_picosec latency, simtime_picosec switch_latency, topology_type type = DFP_DENSE_T);
